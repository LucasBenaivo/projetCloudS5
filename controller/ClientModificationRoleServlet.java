 ...
 * @author Toky
 */
@WebServlet(name = "ClientModificationRoleServlet", urlPatterns = {"/client/ClientModificationRoleServlet"})
public class ClientModificationRoleServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/pages/client/profil/profil-modification-role.jsp");
