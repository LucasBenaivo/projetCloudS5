...
@WebServlet(name = "ClientModificationMdpServlet", urlPatterns = {"/client/ClientModificationMdpServlet"})
public class ClientModificationMdpServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/pages/client/profil/profil-modification-mdp.jsp");
