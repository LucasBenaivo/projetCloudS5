 ...
 * @author Toky
 */
@WebServlet(name = "ClientMouvementFiatWalletServlet", urlPatterns = {"/client/ClientMouvementFiatWalletServlet"})
public class ClientMouvementFiatWalletServlet extends HttpServlet {
    
    static String pageUrl="/pages/client/mouvementfiatwallet/mouvementfiatwallet-saisie.jsp";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection conn = new Connexion().getConnection()) {
            mouvement.insert(conn,email,request);
            // Créer la réponse JSON
            Map<String, Object> responseBody = new HashMap<>();
            responseBody.put("code", 200);
            responseBody.put("success", true); // Mettre à false en cas d'erreur
            responseBody.put("message", "Mouvement effectué avec succès, vérifier votre mail pour valider la transaction");
