 ...
 * @author Toky
 */
@WebServlet(name = "ClientTransactionCryptoServlet", urlPatterns = {"/client/ClientTransactionCryptoServlet"})
public class ClientTransactionCryptoServlet extends HttpServlet {
    
     static String pageUrl="/pages/client/crypto/crypto-interface.jsp";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            switch (action) {
                case "acheter":
                    transaction.insererAchat(idUtilisateur, idCrypto, quantite, prixUnitaire);
                    break;
                case "vendre":
                    transaction.insererVente(idUtilisateur, idCrypto, quantite, prixUnitaire);
                    break;
                default:
